...
import 'kleur/colors';
import { $ as $$Base, a as $$Footer } from './Base_8nhxEKxY.mjs';
import 'clsx';
/* empty css                         */
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CnIk9VlA.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/DEXRabbit", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://avertenandor.github.io/DEXRabbit/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CFbeLTCH.mjs').then(n => n._);
