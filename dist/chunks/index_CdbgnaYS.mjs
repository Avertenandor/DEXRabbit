import { c as createComponent, b as createAstro, m as maybeRenderHead, d as addAttribute, e as renderSlot, a as renderTemplate, r as renderComponent, f as renderScript, g as defineScriptVars, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, u as unescapeHTML, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent } from './astro/server_BDx15eWF.mjs';
import 'kleur/colors';
import { $ as $$Base, a as $$Footer } from './Base_DTb9KVIi.mjs';
import 'clsx';
/* empty css                         */
...
const $$Button = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Button;
  const { href = "#", variant = "primary", size = "md" } = Astro2.props;
  const base = "btn inline-flex items-center justify-center font-medium rounded-[var(--radius-2xl)] focus-visible:outline-none";
  const v = {
    primary: "btn-primary",
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")}${addAttribute(`${base} ${v} ${s}`, "class")}> ${renderSlot($$result, $$slots["default"])} </a>`;
}, "C:/Users/konfu/Desktop/\u041A\u0440\u043E\u043B\u0438\u043A\u0438/site/src/components/ui/Button.astro", void 0);
...
</h1> <!-- Subtitle --> <p class="text-xl md:text-2xl text-[var(--text-secondary)] mb-12 max-w-3xl mx-auto leading-relaxed fade-in" data-astro-cid-bbe6dxrz>
Форс-мажор — возврат тела в PLEX.
</p> <!-- CTA Buttons --> <div class="flex flex-col sm:flex-row gap-6 justify-center items-center fade-in" data-astro-cid-bbe6dxrz> ${renderComponent($$result, "Button", $$Button, { "href": telegramBotUrl, "variant": "primary", "size": "lg", "data-astro-cid-bbe6dxrz": true }, { "default": ($$result2) => renderTemplate`
Открыть Telegram-бот
` })} ${renderComponent($$result, "Button", $$Button, { "href": "#how", "variant": "secondary", "size": "lg", "data-astro-cid-bbe6dxrz": true }, { "default": ($$result2) => renderTemplate`
Как это работает
` })} </div> <!-- Important disclaimer --> <div class="mt-16 p-6 bg-[var(--bg-secondary)] rounded-[var(--radius-xl)] border border-[var(--border-primary)] max-w-2xl mx-auto fade-in" data-astro-cid-bbe6dxrz> <p class="text-sm text-[var(--text-secondary)] leading-relaxed" data-astro-cid-bbe6dxrz> <strong class="text-[var(--accent-primary)]" data-astro-cid-bbe6dxrz>Экономическая модель:</strong> ежедневные начисления — в монете PLEX (параметры публикуются в Telegram-боте).
          По успешному завершению цикла (~3 мес.) возврат тела и прибыль — в USDT. В случае форс-мажора возврат тела — в монете PLEX.
</p> </div> <!-- Hero Image with proper constraints --> <div class="mt-12 relative w-full mx-auto max-w-[1100px] rounded-[calc(var(--radius-2xl)*1.4)] ring-1 ring-[color:var(--ring)] overflow-hidden aspect-[16/9]" data-astro-cid-bbe6dxrz> <img src="/images/photo_2025-09-15_13-17-50.jpg" class="absolute inset-0 h-full w-full object-cover" alt="Кролик в вольере" loading="eager" decoding="async" data-astro-cid-bbe6dxrz> </div> </div> </div> <!-- Carousel Navigation Dots --> <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20" data-astro-cid-bbe6dxrz> <div class="flex space-x-2" data-astro-cid-bbe6dxrz> ${heroRabbits.map((_, index) => renderTemplate`<button${addAttribute(`setSlide(${index})`, "onclick")}${addAttribute(["w-3 h-3 rounded-full transition-all duration-300", [
...
var _a;
const $$RabbitsGallery = createComponent(async ($$result, $$props, $$slots) => {
  let rabbits = [];
  try {
    const jsonPath = path.join(process.cwd(), "public/data/rabbits.json");
    const jsonContent = await promises.readFile(jsonPath, "utf-8");
  ...
  return renderTemplate(_a || (_a = __template(["", '<section id="rabbits-gallery" class="section bg-[var(--bg-secondary)]" data-astro-cid-4gklykvr> <div class="container mx-auto px-6" data-astro-cid-4gklykvr> <div class="max-w-6xl mx-auto" data-astro-cid-4gklykvr> <!-- Section header --> <div class="text-center mb-16" data-astro-cid-4gklykvr> <h2 class="text-4xl md:text-5xl font-bold mb-6" data-astro-cid-4gklykvr>\n\u041D\u0430\u0448\u0438 \u043A\u0440\u043E\u043B\u0438\u043A\u0438\n</h2> <p class="text-xl text-[var(--text-secondary)] max-w-3xl mx-auto" data-astro-cid-4gklykvr>\n\u041F\u043E\u0437\u043D\u0430\u043A\u043E\u043C\u044C\u0442\u0435\u0441\u044C \u0441 \u043D\u0430\u0448\u0438\u043C\u0438 \u043F\u043B\u0435\u043C\u0435\u043D\u043D\u044B\u043C\u0438 \u043A\u0440\u043E\u043B\u0438\u043A\u0430\u043C\u0438 \u0440\u0430\u0437\u043D\u044B\u0445 \u043F\u043E\u0440\u043E\u0434\n</p> </div> <!-- Gallery Grid --> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" data-astro-cid-4gklykvr> ', ' </div> <!-- CTA --> <div class="text-center mt-12" data-astro-cid-4gklykvr> <p class="text-[var(--text-secondary)] mb-6" data-astro-cid-4gklykvr>\n\u0425\u043E\u0442\u0438\u0442\u0435 \u0438\u043D\u0432\u0435\u0441\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0432 \u0440\u0430\u0437\u0432\u0435\u0434\u0435\u043D\u0438\u0435 \u043A\u0440\u043E\u043B\u0438\u043A\u043E\u0432?\n</p> <a href="https://t.me/your_bot" class="btn-primary text-lg px-8 py-4 inline-block" target="_blank" rel="noopener noreferrer" data-astro-cid-4gklykvr>\n\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u043A\u0440\u043E\u043B\u0438\u043A\u0430 \u0432 \u0431\u043E\u0442\u0435\n</a> </div> </div> </div> </section> <!-- Lightbox Modal (React Island) --> <div id="lightbox" class="fixed inset-0 bg-black/90 z-50 hidden" onclick="closeLightbox()" data-astro-cid-4gklykvr> <div class="absolute inset-0 flex items-center justify-center p-4" data-astro-cid-4gklykvr> <div class="relative max-w-4xl max-h-full" onclick="event.stopPropagation()" data-astro-cid-4gklykvr> <img id="lightbox-image" src="" alt="" class="max-w-full max-h-full object-contain" data-astro-cid-4gklykvr> <!-- Close button --> <button onclick="closeLightbox()" class="absolute top-4 right-4 text-white text-2xl hover:text-[var(--accent-primary)] transition-colors" data-astro-cid-4gklykvr>\n\xD7\n</button> <!-- Navigation --> <button onclick="previousImage()" class="absolute left-4 top-1/2 -translate-y-1/2 text-white text-3xl hover:text-[var(--accent-primary)] transition-colors" data-astro-cid-4gklykvr>\n\u2039\n</button> <button onclick="nextImage()" class="absolute right-4 top-1/2 -translate-y-1/2 text-white text-3xl hover:text-[var(--accent-primary)] transition-colors" data-astro-cid-4gklykvr>\n\u203A\n</button> <!-- Info panel --> <div class="absolute bottom-0 left-0 right-0 bg-black/80 text-white p-6" data-astro-cid-4gklykvr> <div class="flex justify-between items-center" data-astro-cid-4gklykvr> <div id="lightbox-info" class="text-sm" data-astro-cid-4gklykvr></div> <div class="flex gap-2" data-astro-cid-4gklykvr> <span id="lightbox-counter" class="text-sm text-[var(--text-secondary)]" data-astro-cid-4gklykvr></span> </div> </div> </div> </div> </div> </div> <script>(function(){', "\n  let currentImageIndex = 0;\n  const rabbitsData = rabbits;\n\n  function openLightbox(index) {\n    currentImageIndex = index;\n    const lightbox = document.getElementById('lightbox');\n    const lightboxImage = document.getElementById('lightbox-image');\n    const lightboxInfo = document.getElementById('lightbox-info');\n    const lightboxCounter = document.getElementById('lightbox-counter');\n\n    const rabbit = rabbits[currentImageIndex];\n    lightboxImage.src = rabbit.src;\n    lightboxImage.alt = `\u041A\u0440\u043E\u043B\u0438\u043A ${rabbit.title}`;\n\n    lightboxInfo.innerHTML = `\n      <div>\n        <h3 class=\"font-semibold\">${rabbit.title}</h3>\n        <p class=\"text-[var(--text-secondary)]\">${rabbit.date}</p>\n        <div class=\"flex flex-wrap gap-1 mt-2\">\n          ${rabbit.tags.map(tag => `<span class=\"px-2 py-1 bg-[var(--accent-primary)]/20 text-[var(--accent-primary)] text-xs rounded-full\">${tag}</span>`).join('')}\n        </div>\n      </div>\n    `;\n\n    lightboxCounter.textContent = `${currentImageIndex + 1} / ${rabbits.length}`;\n    lightbox.classList.remove('hidden');\n    document.body.style.overflow = 'hidden';\n  }\n\n  function closeLightbox() {\n    const lightbox = document.getElementById('lightbox');\n    lightbox.classList.add('hidden');\n    document.body.style.overflow = '';\n  }\n\n  function nextImage() {\n    currentImageIndex = (currentImageIndex + 1) % rabbits.length;\n    openLightbox(currentImageIndex);\n  }\n\n  function previousImage() {\n    currentImageIndex = (currentImageIndex - 1 + rabbits.length) % rabbits.length;\n    openLightbox(currentImageIndex);\n  }\n\n  // Keyboard navigation\n  document.addEventListener('keydown', (e) => {\n    if (document.getElementById('lightbox').classList.contains('hidden')) return;\n\n    if (e.key === 'Escape') closeLightbox();\n    if (e.key === 'ArrowRight') nextImage();\n    if (e.key === 'ArrowLeft') previousImage();\n  });\n\n  // Respect user's motion preferences\n  if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {\n    // Disable smooth transitions for users who prefer reduced motion\n    const style = document.createElement('style');\n    style.textContent = `\n      .card:hover img {\n        transform: none !important;\n      }\n    `;\n    document.head.appendChild(style);\n  }\n})();<\/script> "], ["", '<section id="rabbits-gallery" class="section bg-[var(--bg-secondary)]" data-astro-cid-4gklykvr> <div class="container mx-auto px-6" data-astro-cid-4gklykvr> <div class="max-w-6xl mx-auto" data-astro-cid-4gklykvr> <!-- Section header --> <div class="text-center mb-16" data-astro-cid-4gklykvr> <h2 class="text-4xl md:text-5xl font-bold mb-6" data-astro-cid-4gklykvr>\n\u041D\u0430\u0448\u0438 \u043A\u0440\u043E\u043B\u0438\u043A\u0438\n</h2> <p class="text-xl text-[var(--text-secondary)] max-w-3xl mx-auto" data-astro-cid-4gklykvr>\n\u041F\u043E\u0437\u043D\u0430\u043A\u043E\u043C\u044C\u0442\u0435\u0441\u044C \u0441 \u043D\u0430\u0448\u0438\u043C\u0438 \u043F\u043B\u0435\u043C\u0435\u043D\u043D\u044B\u043C\u0438 \u043A\u0440\u043E\u043B\u0438\u043A\u0430\u043C\u0438 \u0440\u0430\u0437\u043D\u044B\u0445 \u043F\u043E\u0440\u043E\u0434\n</p> </div> <!-- Gallery Grid --> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" data-astro-cid-4gklykvr> ', ' </div> <!-- CTA --> <div class="text-center mt-12" data-astro-cid-4gklykvr> <p class="text-[var(--text-secondary)] mb-6" data-astro-cid-4gklykvr>\n\u0425\u043E\u0442\u0438\u0442\u0435 \u0438\u043D\u0432\u0435\u0441\u0442\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0432 \u0440\u0430\u0437\u0432\u0435\u0434\u0435\u043D\u0438\u0435 \u043A\u0440\u043E\u043B\u0438\u043A\u043E\u0432?\n</p> <a href="https://t.me/your_bot" class="btn-primary text-lg px-8 py-4 inline-block" target="_blank" rel="noopener noreferrer" data-astro-cid-4gklykvr>\n\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u043A\u0440\u043E\u043B\u0438\u043A\u0430 \u0432 \u0431\u043E\u0442\u0435\n</a> </div> </div> </div> </section> <!-- Lightbox Modal (React Island) --> <div id="lightbox" class="fixed inset-0 bg-black/90 z-50 hidden" onclick="closeLightbox()" data-astro-cid-4gklykvr> <div class="absolute inset-0 flex items-center justify-center p-4" data-astro-cid-4gklykvr> <div class="relative max-w-4xl max-h-full" onclick="event.stopPropagation()" data-astro-cid-4gklykvr> <img id="lightbox-image" src="" alt="" class="max-w-full max-h-full object-contain" data-astro-cid-4gklykvr> <!-- Close button --> <button onclick="closeLightbox()" class="absolute top-4 right-4 text-white text-2xl hover:text-[var(--accent-primary)] transition-colors" data-astro-cid-4gklykvr>\n\xD7\n</button> <!-- Navigation --> <button onclick="previousImage()" class="absolute left-4 top-1/2 -translate-y-1/2 text-white text-3xl hover:text-[var(--accent-primary)] transition-colors" data-astro-cid-4gklykvr>\n\u2039\n</button> <button onclick="nextImage()" class="absolute right-4 top-1/2 -translate-y-1/2 text-white text-3xl hover:text-[var(--accent-primary)] transition-colors" data-astro-cid-4gklykvr>\n\u203A\n</button> <!-- Info panel --> <div class="absolute bottom-0 left-0 right-0 bg-black/80 text-white p-6" data-astro-cid-4gklykvr> <div class="flex justify-between items-center" data-astro-cid-4gklykvr> <div id="lightbox-info" class="text-sm" data-astro-cid-4gklykvr></div> <div class="flex gap-2" data-astro-cid-4gklykvr> <span id="lightbox-counter" class="text-sm text-[var(--text-secondary)]" data-astro-cid-4gklykvr></span> </div> </div> </div> </div> </div> </div> <script>(function(){', "\n  let currentImageIndex = 0;\n  const rabbitsData = rabbits;\n\n  function openLightbox(index) {\n    currentImageIndex = index;\n    const lightbox = document.getElementById('lightbox');\n    const lightboxImage = document.getElementById('lightbox-image');\n    const lightboxInfo = document.getElementById('lightbox-info');\n    const lightboxCounter = document.getElementById('lightbox-counter');\n\n    const rabbit = rabbits[currentImageIndex];\n    lightboxImage.src = rabbit.src;\n    lightboxImage.alt = \\`\u041A\u0440\u043E\u043B\u0438\u043A \\${rabbit.title}\\`;\n\n    lightboxInfo.innerHTML = \\`\n      <div>\n        <h3 class=\"font-semibold\">\\${rabbit.title}</h3>\n        <p class=\"text-[var(--text-secondary)]\">\\${rabbit.date}</p>\n        <div class=\"flex flex-wrap gap-1 mt-2\">\n          \\${rabbit.tags.map(tag => \\`<span class=\"px-2 py-1 bg-[var(--accent-primary)]/20 text-[var(--accent-primary)] text-xs rounded-full\">\\${tag}</span>\\`).join('')}\n        </div>\n      </div>\n    \\`;\n\n    lightboxCounter.textContent = \\`\\${currentImageIndex + 1} / \\${rabbits.length}\\`;\n    lightbox.classList.remove('hidden');\n    document.body.style.overflow = 'hidden';\n  }\n\n  function closeLightbox() {\n    const lightbox = document.getElementById('lightbox');\n    lightbox.classList.add('hidden');\n    document.body.style.overflow = '';\n  }\n\n  function nextImage() {\n    currentImageIndex = (currentImageIndex + 1) % rabbits.length;\n    openLightbox(currentImageIndex);\n  }\n\n  function previousImage() {\n    currentImageIndex = (currentImageIndex - 1 + rabbits.length) % rabbits.length;\n    openLightbox(currentImageIndex);\n  }\n\n  // Keyboard navigation\n  document.addEventListener('keydown', (e) => {\n    if (document.getElementById('lightbox').classList.contains('hidden')) return;\n\n    if (e.key === 'Escape') closeLightbox();\n    if (e.key === 'ArrowRight') nextImage();\n    if (e.key === 'ArrowLeft') previousImage();\n  });\n\n  // Respect user's motion preferences\n  if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {\n    // Disable smooth transitions for users who prefer reduced motion\n    const style = document.createElement('style');\n    style.textContent = \\`\n      .card:hover img {\n        transform: none !important;\n      }\n    \\`;\n    document.head.appendChild(style);\n  }\n})();<\/script> "])), maybeRenderHead(), rabbits.map((rabbit, index) => renderTemplate`<div class="group cursor-pointer"${addAttribute(`openLightbox(${index})`, "onclick")} data-astro-cid-4gklykvr> <div class="aspect-[4/3] overflow-hidden rounded-lg bg-[var(--bg-tertiary)] mb-3" data-astro-cid-4gklykvr> <picture data-astro-cid-4gklykvr> <source${addAttribute(`${rabbit.src}@480.webp 480w, ${rabbit.src}@960.webp 960w, ${rabbit.src}@1440.webp 1440w`, "srcset")} type="image/webp" data-astro-cid-4gklykvr> <img${addAttribute(rabbit.src, "src")} sizes="(max-width:640px) 100vw, (max-width:1024px) 50vw, 33vw"${addAttribute(`${rabbit.title}`, "alt")} class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300 ring-1 ring-white/5" loading="lazy" decoding="async" data-astro-cid-4gklykvr> </picture> </div> <div class="space-y-2" data-astro-cid-4gklykvr> <div class="flex items-center justify-between" data-astro-cid-4gklykvr> <h3 class="font-semibold text-[var(--text-primary)]" data-astro-cid-4gklykvr> ${rabbit.title} </h3> <span class="text-xs text-[var(--text-muted)] bg-[var(--bg-tertiary)] px-2 py-1 rounded-full" data-astro-cid-4gklykvr> ${rabbit.date} </span> </div> <div class="flex flex-wrap gap-1" data-astro-cid-4gklykvr> ${rabbit.tags.slice(0, 2).map((tag) => renderTemplate`<span class="px-2 py-1 bg-[var(--accent-primary)]/20 text-[var(--accent-primary)] text-xs rounded-full" data-astro-cid-4gklykvr> ${tag} </span>`)} </div> <p class="text-sm text-[var(--text-secondary)]" data-astro-cid-4gklykvr> ${rabbit.age} • ${rabbit.line} </p> <p class="text-sm text-[var(--text-muted)]" data-astro-cid-4gklykvr> ${rabbit.description} </p> </div> </div>`), defineScriptVars({ rabbits }));
...
const $$PlexTicker = createComponent(($$result, $$props, $$slots) => {
  const geckoTerminalUrl = "https://www.geckoterminal.com/plex/pools/0x41d9650f...1889";
  return renderTemplate`${maybeRenderHead()}<section id="plex-ticker" class="section bg-[var(--bg-secondary)]"> <div class="container mx-auto px-6"> <div class="max-w-4xl mx-auto"> <!-- Section header --> <div class="text-center mb-8"> <h2 class="text-3xl md:text-4xl font-bold mb-4">
Курс PLEX
</h2> <p class="text-lg text-[var(--text-secondary)]">
Актуальная информация о курсе PLEX в реальном времени
</p> </div> <!-- PLEX Chart Container --> <div class="relative w-full mx-auto rounded-[var(--radius-2xl)] ring-1 ring-[color:var(--ring)] overflow-hidden aspect-[16/9] bg-[var(--bg-tertiary)]"> <iframe${addAttribute(geckoTerminalUrl, "src")} class="absolute inset-0 w-full h-full border-0" title="PLEX Price Chart" loading="lazy" allow="clipboard-write"></iframe> </div> <!-- Important Disclaimer --> <div class="mt-8 p-6 bg-[var(--bg-tertiary)] rounded-[var(--radius-xl)] border border-[var(--border-primary)]"> <div class="flex items-start gap-3"> <div class="flex-shrink-0 w-6 h-6 rounded-full bg-[var(--accent-warning)] flex items-center justify-center"> <span class="text-sm font-bold text-[var(--bg-primary)]">!</span> </div> <div class="space-y-3"> <h3 class="font-semibold text-[var(--text-primary)]">
Важная информация о PLEX
</h3> <div class="space-y-2 text-sm text-[var(--text-secondary)]"> <p> <strong>Мы не продаём и не обмениваем PLEX.</strong> В штатной модели вы получаете ежедневные бонусы в PLEX, а <strong>основная выплата и прибыль — в USDT</strong>.
</p> <p>
В случае форс-мажора возврат внесённой суммы производится <strong>в PLEX</strong> согласно правилам проекта.
</p> <p class="text-[var(--accent-warning)]"> <strong>PLEX — волатильный актив.</strong> Оцените риски перед участием. Параметры начислений и правила доступны в Telegram-боте.
</p> </div> </div> </div> </div> <!-- CTA Button --> <div class="text-center mt-8"> <a href="https://t.me/your_bot" class="btn-primary inline-flex items-center gap-2" target="_blank" rel="noopener noreferrer">
Открыть Telegram-бот
</a> </div> </div> </div> </section>`;
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BM3MbVh7.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://xn--80apapgbbfxgmuj4j.site/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Bxqm6eZ-.mjs').then(n => n._);
...
const $$InvestorsWall = createComponent(async ($$result, $$props, $$slots) => {
  let investors = [];
  try {
