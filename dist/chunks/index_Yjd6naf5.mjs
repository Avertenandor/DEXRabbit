import { c as createComponent, m as maybeRenderHead, b as addAttribute, d as renderScript, a as renderTemplate, e as defineScriptVars, A as AstroError, U as UnknownContentCollectionError, R as RenderUndefinedEntryError, u as unescapeHTML, f as renderUniqueStylesheet, g as renderScriptElement, h as createHeadAndContent, r as renderComponent, i as createAstro } from './astro/server_CuhdW62i.mjs';
import 'kleur/colors';
import { $ as $$Base, a as $$Footer } from './Base_PbEwvPWe.mjs';
import 'clsx';
/* empty css                         */
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_COoUw8YQ.mjs').then(n => n._);
