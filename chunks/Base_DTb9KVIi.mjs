import { c as createComponent, m as maybeRenderHead, d as addAttribute, f as renderScript, a as renderTemplate, r as renderComponent, b as createAstro, k as renderHead, e as renderSlot } from './astro/server_BDx15eWF.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                         */
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<header class="sticky top-0 z-50 bg-[var(--bg-primary)]/80 backdrop-blur-md border-b border-[var(--border-subtle)]" style="padding-top: env(safe-area-inset-top, 0px);" data-astro-cid-3ef6ksr2> <div class="container" data-astro-cid-3ef6ksr2> <div class="flex items-center justify-between h-16" data-astro-cid-3ef6ksr2> <!-- Logo --> <a href="/" class="flex items-center space-x-2" aria-label="DEXRabbit - Главная" data-astro-cid-3ef6ksr2> <div class="w-8 h-8 bg-[var(--accent-primary)] rounded-lg flex items-center justify-center" data-astro-cid-3ef6ksr2> <span class="text-white font-bold text-sm" data-astro-cid-3ef6ksr2>R</span> </div> <span class="font-bold text-lg text-[var(--text-primary)]" data-astro-cid-3ef6ksr2>DEXRabbit</span> </a> <!-- Desktop Navigation --> <nav class="hidden md:flex items-center space-x-8" data-astro-cid-3ef6ksr2> <a href="/#plex" class="text-[var(--text-secondary)] hover:text-[var(--accent-primary)] transition-colors font-medium" data-astro-cid-3ef6ksr2>
Курс PLEX
...
const $$StickyCta = createComponent(($$result, $$props, $$slots) => {
  const telegramBotUrl = "https://t.me/your_bot";
  return renderTemplate`${maybeRenderHead()}<div id="sticky-cta" class="fixed bottom-0 left-0 right-0 z-40 bg-[var(--bg-primary)] border-t border-[var(--border-primary)] sm:hidden backdrop-blur-md" data-astro-cid-544d75lg> <div class="container" data-astro-cid-544d75lg> <div class="flex items-center justify-center py-3 safe-area-bottom" data-astro-cid-544d75lg> <a${addAttribute(telegramBotUrl, "href")} class="btn-primary w-full max-w-sm justify-center text-sm" target="_blank" rel="noopener noreferrer" style="padding-bottom: max(0.75rem, env(safe-area-inset-bottom, 0px));" data-astro-cid-544d75lg>
Открыть Telegram-бот
...
const $$Base = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="ru" class="dark" data-astro-cid-5hce7sga> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="generator"${addAttribute(Astro2.generator, "content")}><!-- Icons & PWA --><link rel="icon"${addAttribute(Astro2.resolve("/favicon.ico"), "href")}><link rel="apple-touch-icon" sizes="192x192"${addAttribute(Astro2.resolve("/icon-192.png"), "href")}><link rel="icon" type="image/png" sizes="512x512"${addAttribute(Astro2.resolve("/icon-512.png"), "href")}><link rel="manifest"${addAttribute(Astro2.resolve("/site.webmanifest"), "href")}><!-- SEO Meta Tags --><title>${title}</title><meta name="description"${addAttribute(description, "content")}><!-- OpenGraph / Twitter --><meta property="og:title" content="DEXRabbit — USDT-вход, ежедневные PLEX-бонусы, итоговая выплата в USDT"><meta property="og:description" content="Штатная модель — USDT-выплата по итогу цикла; форс-мажор — возврат тела в PLEX. Все операции — в Telegram-боте."><meta property="og:image"${addAttribute(Astro2.resolve("/og/og-image.svg"), "content")}><meta name="twitter:card" content="summary_large_image"><!-- Perf hints --><link rel="preconnect" href="https://api.geckoterminal.com" crossorigin><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><meta name="theme-color" content="#0B0D10"><!-- Import design tokens --><link rel="stylesheet" href="/src/styles/tokens.css"><!-- Global styles -->${renderHead()}</head> <body class="bg-[var(--bg-primary)] text-[var(--text-primary)] antialiased min-h-screen flex flex-col" data-astro-cid-5hce7sga> ${renderComponent($$result, "Header", $$Header, { "data-astro-cid-5hce7sga": true })} <main class="flex-1" data-astro-cid-5hce7sga> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, { "data-astro-cid-5hce7sga": true })} ${renderComponent($$result, "StickyCta", $$StickyCta, { "data-astro-cid-5hce7sga": true })} </body></html>`;
